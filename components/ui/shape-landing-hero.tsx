...
function HeroGeometric({
    badge = "AI Powered",
    title1 = "Transform Your Database Experience",
    title2 = "with Natural Language AI",
}: {
    badge?: string;
    title1?: string;
    title2?: string;
                ...
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    >
                        <p className="text-base sm:text-lg md:text-xl text-white/40 mb-8 leading-relaxed font-light tracking-wide max-w-xl mx-auto px-4">
                            Interact with your databases using natural language. Get instant insights, 
                            generate SQL queries, and manage your data with AI-powered assistance.
                        </p>
                    </motion.div>
                    ...
                    >
                        <Button 
                            size="lg"
                            className="group relative overflow-hidden bg-primary hover:from-primary/90 hover:to-accent/90 text-white px-8 py-6 text-lg font-medium transition-all duration-300 ease-out hover:scale-105"
                        ...
                        {/* <Button 
                            variant="outline"
                            size="lg"
                            className="group relative overflow-hidden border-white/10 bg-white/5 hover:bg-white/10 text-white px-8 py-6 text-lg font-medium transition-all duration-300 ease-out hover:scale-105"
