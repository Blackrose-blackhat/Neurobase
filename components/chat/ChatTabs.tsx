...
import { Table2, MessageSquare, Loader2, AlertCircle, LoaderPinwheel, LoaderPinwheelIcon, Database } from "lucide-react";
...
export function ChatTabs({
  ...
  const isDatabaseOverview = message.data && message.data.databaseName;
      ...
      <Card className="p-4 bg-muted">
        <Tabs defaultValue="overview" className="w-full">
          ...
          <TabsContent value="overview">
            <DatabaseOverview data={message.data} />
          </TabsContent>
